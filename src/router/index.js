    ...
    children: [
      {
        ...
        meta: { title: '个人画像', icon: 'UserFilled', requiresAuth: true, roles: ['allLeader'] }
      },
      {
        path: 'board',
        name: 'Board',
        component: () => import('@/views/portrait/Board.vue'),
        meta: { title: '表单展示', icon: 'Grid', requiresAuth: true, roles: ['allLeader'] }
      },
      {
        path: 'kmeans',
        name: 'KMeans',
        component: () => import('@/views/portrait/KMeans.vue'),
        meta: { title: '图表分析', icon: 'TrendCharts', requiresAuth: true, roles: ['allLeader'] }
      },
      {
        path: 'agent',
        name: 'Agent',
        component: () => import('@/views/portrait/Agent.vue'),
        meta: { title: '智能建议', icon: 'ChatLineRound', requiresAuth: true, roles: ['allLeader'] }
      },
      {
        path: 'profile',
        name: 'Profile',
